...
namespace fyiReporting.RdlCmd
{
	...
	public class RdlCmd
	{
		...
		{
			Console.WriteLine(string.Format("RdlCmd Version {0}",
                            Assembly.GetExecutingAssembly().GetName().Version.ToString()));
            Console.WriteLine("Copyright (c) 2011-2013 Inpro-Soft GmbH (http://www.unierm.de)");
            Console.WriteLine("Copyright (c) 2010 devFU Pty Ltd, Josh Wilson and Others (http://reportfu.org)");
