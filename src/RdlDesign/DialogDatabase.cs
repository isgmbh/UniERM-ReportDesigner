...
namespace Reporting.RdlDesign
{
	...
	{
		IPasswordProvider _pwdProvider=null;
...
|endif|
	...
	<PageFooter>
		...
		private Reporting.Viewer.RdlViewer rdlViewer1;
...
|endif|
	...
	<PageFooter>
		...
		public DialogDatabase(IPasswordProvider pwdProvider)
		{
		...
		private void InitializeComponent()
		{
            ...
            this.pnlParamEditor = new System.Windows.Forms.Panel();
            ...
            this.pnlParamEditor.SuspendLayout();
    ...
    "ut=5";
            ...
            // ReportParameters
            // 
            this.ReportParameters.Controls.Add(this.pnlParamEditor);
            ...
            // pnlParamEditor
            // 
            this.pnlParamEditor.Controls.Add(this.lParmName);
            this.pnlParamEditor.Controls.Add(this.bValidValues);
            this.pnlParamEditor.Controls.Add(this.tbParmName);
            this.pnlParamEditor.Controls.Add(this.tbParmDefaultValue);
            this.pnlParamEditor.Controls.Add(this.lParmType);
            this.pnlParamEditor.Controls.Add(this.lDefaultValue);
            this.pnlParamEditor.Controls.Add(this.cbParmType);
            this.pnlParamEditor.Controls.Add(this.lParmPrompt);
            this.pnlParamEditor.Controls.Add(this.tbParmPrompt);
            this.pnlParamEditor.Controls.Add(this.tbParmValidValues);
            this.pnlParamEditor.Controls.Add(this.ckbParmAllowNull);
            this.pnlParamEditor.Controls.Add(this.lbParmValidValues);
            this.pnlParamEditor.Controls.Add(this.ckbParmAllowBlank);
            this.pnlParamEditor.Enabled = false;
            this.pnlParamEditor.Location = new System.Drawing.Point(215, 24);
            this.pnlParamEditor.Name = "pnlParamEditor";
            this.pnlParamEditor.Size = new System.Drawing.Size(275, 251);
            this.pnlParamEditor.TabIndex = 17;
            // 
            // lParmName
            // 
            this.lParmName.Location = new System.Drawing.Point(3, 0);
            ...
            // bValidValues
            // 
            this.bValidValues.Location = new System.Drawing.Point(227, 128);
            ...
            this.bValidValues.Click += new System.EventHandler(this.paramFields_Changed);
            // 
            // tbParmName
            // 
            this.tbParmName.Location = new System.Drawing.Point(83, 0);
            this.tbParmName.Name = "tbParmName";
            this.tbParmName.Size = new System.Drawing.Size(136, 20);
            this.tbParmName.TabIndex = 4;
            this.tbParmName.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.paramFields_KeyPress);
            this.tbParmName.Leave += new System.EventHandler(this.paramFields_Changed);
            // 
            // tbParmDefaultValue
            // 
            this.tbParmDefaultValue.Location = new System.Drawing.Point(3, 176);
            ...
            this.tbParmDefaultValue.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.paramFields_KeyPress);
            this.tbParmDefaultValue.Leave += new System.EventHandler(this.paramFields_Changed);
            // 
            // lParmType
            // 
            this.lParmType.Location = new System.Drawing.Point(3, 32);
            ...
            // lDefaultValue
            // 
            this.lDefaultValue.Location = new System.Drawing.Point(3, 160);
            ...
            "Float",
            "String"});
            this.cbParmType.Location = new System.Drawing.Point(83, 32);
            this.cbParmType.Name = "cbParmType";
            this.cbParmType.Size = new System.Drawing.Size(80, 21);
            this.cbParmType.TabIndex = 6;
            this.cbParmType.SelectedIndexChanged += new System.EventHandler(this.paramFields_Changed);
            // 
            // lParmPrompt
            // 
            this.lParmPrompt.Location = new System.Drawing.Point(3, 64);
            ...
            // tbParmPrompt
            // 
            this.tbParmPrompt.Location = new System.Drawing.Point(3, 80);
            this.tbParmPrompt.Name = "tbParmPrompt";
            this.tbParmPrompt.Size = new System.Drawing.Size(216, 20);
            this.tbParmPrompt.TabIndex = 8;
            this.tbParmPrompt.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.paramFields_KeyPress);
            this.tbParmPrompt.Leave += new System.EventHandler(this.paramFields_Changed);
            // 
            // tbParmValidValues
            // 
            this.tbParmValidValues.Location = new System.Drawing.Point(3, 128);
            ...
            this.tbParmValidValues.Leave += new System.EventHandler(this.paramFields_Changed);
            // 
            // ckbParmAllowNull
            // 
            this.ckbParmAllowNull.Location = new System.Drawing.Point(3, 208);
            ...
            this.ckbParmAllowNull.Click += new System.EventHandler(this.paramFields_Changed);
            // 
            // lbParmValidValues
            // 
            this.lbParmValidValues.Location = new System.Drawing.Point(3, 112);
            ...
            // ckbParmAllowBlank
            // 
            this.ckbParmAllowBlank.Location = new System.Drawing.Point(83, 208);
            ...
            this.ckbParmAllowBlank.Click += new System.EventHandler(this.paramFields_Changed);
            // 
            // bParmDown
            // 
            ...
            this.pnlParamEditor.ResumeLayout(false);
            this.pnlParamEditor.PerformLayout();
		...
		private void DoReportSyntaxParameters(CultureInfo cinfo, StringBuilder sb)
		{
			...
			foreach (ReportParm rp in lbParameters.Items)
			{
				...
				if (rp.DefaultValue != null && rp.DefaultValue.Count > 0)
				{
					...
					{
						sb.AppendFormat(cinfo, "<Value>{0}</Value>", Rdl.Xml.ToXmlAnsi(dv));
					}
				...
				if (rp.ValidValues != null && rp.ValidValues.Count > 0)
				{
					...
					foreach (ParameterValueItem pvi in rp.ValidValues)
					{
                        ...
                        sb.AppendFormat(cinfo, "<Value>{0}</Value>", Rdl.Xml.ToXmlAnsi(pvi.Value));
						if (pvi.Label != null)
                            sb.AppendFormat(cinfo, "<Label>{0}</Label>", Rdl.Xml.ToXmlAnsi(pvi.Label));
						sb.Append("</ParameterValue>");
					}
		...
		private bool DoReportPreview()
		{
            ...
            rdlViewer1.GetDataSourceReferencePassword = _pwdProvider.GetPassword; 
		...
		private string GetDataProvider()
		{
			...
			{
                if (!DesignerUtility.GetSharedConnectionInfo(_pwdProvider, tbConnection.Text, out cType, out _StashConnection))
                    return null;
			}
			else
			{
		...
		{
			tbReportSyntax.Text = "";	// when ReportName changes get rid of report syntax
		}

		private void tbReportDescription_TextChanged(object sender, System.EventArgs e)
		{
			tbReportSyntax.Text = "";	// when ReportDescription changes get rid of report syntax
		}

		private void tbReportAuthor_TextChanged(object sender, System.EventArgs e)
		{
			tbReportSyntax.Text = "";	// when ReportAuthor changes get rid of report syntax
		}

		private void rbTable_CheckedChanged(object sender, System.EventArgs e)
		{
			tbReportSyntax.Text = "";	// when Report Type changes get rid of report syntax
		...
		{
            //Josh 6:24:10 Moved Parameter Editor controls to a new panel
            //  to enabled disabling them easier to show you need to click
            // add prior to adding a parameter.
            this.pnlParamEditor.Enabled = true;
		...
		private void lbParameters_SelectedIndexChanged(object sender, System.EventArgs e)
		{
            ...
            if (cur < 0)
            {
                // Josh 6:24:10 See above comment about moving 
                // param editor controls to a panel.
                this.pnlParamEditor.Enabled = false;
                return;
            }
        ...
        // Josh: 6:24:10 Moved all the param fields modification code into 
        // one procedure and made them only edit when the field is 
        // exited (for the text fields, all others remain the same)
        // to cut down on parameter updates.
        private void paramFields_Changed(object sender, EventArgs e)
        {
            UpdateParameter(lbParameters.SelectedIndex, sender);
        }

        private void UpdateParameter(int index, object sender)
        {
            ...
            ReportParm rp = lbParameters.Items[index] as ReportParm;
            if (rp == null)
            {
                // Josh 6:24:10 See above comment about moving 
                // param editor controls to a panel.
            ...
            this.pnlParamEditor.Enabled = true;
            // Josh 6:24:10 .Name property used in case control names
            // ever change.
            if (sender.Equals(tbParmName))
            {
                rp.Name = tbParmName.Text;

                lbParameters_MoveItem(index, index);
            }
            else if (sender.Equals(tbParmDefaultValue))
            {
            ...
            else if (sender.Equals(tbParmPrompt))
            {
                rp.Prompt = tbParmPrompt.Text;
            }
            else if (sender.Equals(bValidValues))
            {
            ...
            else if (sender.Equals(cbParmType))
            {
                rp.DataType = cbParmType.Text;
            }
            else if (sender.Equals(ckbParmAllowBlank))
            {
                rp.AllowBlank = ckbParmAllowBlank.Checked;
            }
            else if (sender.Equals(ckbParmAllowNull))
            {
                rp.AllowNull = ckbParmAllowNull.Checked;
            }
        }
        
        private void paramFields_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar.Equals(Keys.Enter) || e.KeyChar.Equals(Keys.Return))
            {
                paramFields_Changed(sender, new EventArgs());
            }
        }
        #endregion
