/*
	...
	Added DoubleClick support for tvOp
*/
...
namespace Reporting.RdlDesign
{
	...
	public class DialogExprEditor : System.Windows.Forms.Form
	{
      ...
      { 
        ...
        //Josh: 6:22:10 Unified the call methods and refactored 
        // for easier reading/managing of shorcuts.
		...
		void InitFunctions()
		{
			...
			Reporting.Rdl.FontStyleEnum fsi = FontStyleEnum.Italic;	// just want a class from RdlEngine.dll assembly
			Assembly a = Assembly.GetAssembly(fsi.GetType());
			if (a == null)
				return;
			Type ft = a.GetType("Reporting.RDL.VBFunctions");	 
			BuildMethods(ar, ft, "");

			// build list of financial methods in Financial class
			ft = a.GetType("Reporting.RDL.Financial");
