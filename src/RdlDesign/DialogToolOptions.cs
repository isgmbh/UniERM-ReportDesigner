...
namespace Reporting.RdlDesign
{
	...
	public class DialogToolOptions : System.Windows.Forms.Form
	{
		...
		private void Init()
		{
            this.tbRecentFilesMax.Text = Settings.Default.RecentFilesMax.ToString();
			this.tbHelpUrl.Text = Settings.Default.HelpURL;
            ...
            */
            this.cbEditLines.Checked = Settings.Default.ShowEditLines;
            this.cbOutline.Checked = Settings.Default.ShowReportItemOutline;
            this.cbTabInterface.Checked = Settings.Default.ShowTabbedInterface;
            chkPBAutoHide.Checked = Settings.Default.PropertiesAutoHide;
            this.cbShowReportWaitDialog.Checked = Settings.Default.ShowPreviewWaitDialog;

            switch (Settings.Default.PropertiesLocation)
            {
                case DockStyle.Top:
		...
		{
            Uri optFileName = new Uri(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "config.xml"));
        ...
        {
            lbMaps.Items.Clear();
            lbMaps.Items.AddRange(RdlDesignerForm.MapSubtypes);
        }
		...
		private bool DoApply()
		{
			lock(this)
			{
				try
				{
                    ...
                    Settings.Default.HelpURL = this.tbHelpUrl.Text;
                    HandleShows();
                    HandleProperties();
					if (bToolbar)
						HandleToolbar();
        ...
        private void HandleProperties()
        {
            ...
            Settings.Default.PropertiesLocation = ds;
            Settings.Default.PropertiesAutoHide = chkPBAutoHide.Checked;
        }
		...
		private void HandleDesktop()
		{
			...
			_DesktopDocument.Save(optFileName.LocalPath);
        ...
        private void HandleMaps()
        {
            ...
            RdlDesignerForm.MapSubtypes = maps;
        }
        ...
        private void HandleRecentFilesMax()
		{
            ...
            if (Settings.Default.RecentFilesMax == i)	// if not different we don't need to do anything
				return;

            Settings.Default.RecentFilesMax = i;
        ...
        {
            Settings.Default.ShowEditLines = this.cbEditLines.Checked;
            Settings.Default.ShowReportItemOutline = this.cbOutline.Checked;
            Settings.Default.ShowTabbedInterface = this.cbTabInterface.Checked;
            Settings.Default.ShowPreviewWaitDialog = this.cbShowReportWaitDialog.Checked;
