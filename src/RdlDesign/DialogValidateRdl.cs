...
namespace Reporting.RdlDesign
{
	...
	public class DialogValidateRdl : System.Windows.Forms.Form
	{
		...
		//REBADGE: Update schema to new project local schema. All <fyi: /> tags would need updating too.
        ...
        internal DialogValidateRdl(MDIChild currentChild)
		{
			mc = currentChild;
			//
