/*
	...
	Added Doc file type to RTF label. 
*/
...
namespace Reporting.RdlDesign
{
	...
	internal class MDIChild : Form
	{
		...
		private Reporting.RdlDesign.RdlEditPreview rdlDesigner;
		Uri _SourceFile;
        TabPage _Tab;               // TabPage for this MDI Child

		public MDIChild(int width, int height)
		{
			this.rdlDesigner = new Reporting.RdlDesign.RdlEditPreview();
			this.SuspendLayout();
			// 
			// rdlDesigner
			// 
        ...
        public bool Export()
        {
            ...
            sfd.Filter = "PDF file (*.pdf)|*.pdf|"
             + "CSV file (*.csv)|*.csv|"
             + "XML file (*.xml)|*.xml|"
             + "TIF file (*.tif, *.tiff)|*.tiff;*.tif|"
             + "RTF file (*.rtf)|*.rtf|DOC file (*.doc)|*.doc|"
            ...
            try
            {
                ...
                string type = sfd.FileName.Substring(sfd.FileName.IndexOf(".") + 1);
		...
		public bool Export(string type)
		{
			...
			switch (type.ToLower())
			{
                ...
                case "tif": case "tiff":
                    ...
                    break;
                //Josh: Doc added for user benefit. Same as RTF.
                case "rtf": case "doc":
...
/// </summary>
		...
		private void MDIChild_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
            ...
            if (ctl.Controls.Count == 0)
            {
                ...
                if (ctl.Parent != null)
                {
                    ctl.Parent.BackColor = Color.Gray;
                }
            }
		...
		public Reporting.Viewer.RdlViewer Viewer
		{
