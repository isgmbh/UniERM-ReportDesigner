...
/// <summary>
/// Legacy class. It it not used anymore. New code / code moved to RdlDesignerForm. Work by reportFU: Josh Wilson
/// </summary>
...
//                        //Uri filename = new Uri(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + RdlDesigner.IpcFileName);
//                        //if (!File.Exists(filename.LocalPath))
//                        //    return;

//                        try
//                        {
//                            //    using (StreamReader sr = new StreamReader(filename.LocalPath, Encoding.Unicode))
//                            //    {
...
//        {
//            // Josh: Changed the switch statement to an Enum.Parse instead
//            DockStyle ds;
//            try
//            {
...
//            //ctlSelectTool.FlatStyle = FlatStyle.System;
//            //ctlSelectTool.FlatStyle = FlatStyle.Popup;
...
//            //ctlBold.FlatStyle = FlatStyle.Popup;
//            //ctlBold.FlatStyle = FlatStyle.System;
...
//            //ctlItalic.FlatStyle = FlatStyle.System;
//            //ctlItalic.FlatStyle = FlatStyle.Popup;
//            ToolTip tipb = new ToolTip();
//            tipb.AutomaticDelay = 500;
//            tipb.ShowAlways = true;
...
//            //ctlUnderline.FlatStyle = FlatStyle.Popup;
//            //ctlUnderline.FlatStyle = FlatStyle.System;
//            ToolTip tipb = new ToolTip();
//            tipb.AutomaticDelay = 500;
//            tipb.ShowAlways = true;
...
//            // bCsv
//            // 
//            this.bCsv.Image = ((System.Drawing.Image)(resources.GetObject("bCsv.Image")));
...
//            // Create view menu and add array of sub-menu items
...
//            // Create data menu and add array of sub-menu items
...
//            // Create format menu and add array of sub-menu items
...
//            // Create tools menu and add array of sub-menu items
...
//            // Create the Window menu and add array of sub-menu items
...
//        {
//            // Josh: Changed optFileName from string to Uri
//            // Josh: 6:23:10 Changed to System.IO.Path.Combine()
//            // and moved designerstate.xml to Resources folder.
//            Uri optFileName = new Uri(Path.Combine(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Config"), "designerstate.xml"));
...
//                            {
//                                // Josh: Changed file from string to Uri
...
//                // and moved designerstate.xml to Resources folder.
//                Uri optFileName = new Uri(Path.Combine(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Config"), "designerstate.xml"));
//                xDoc.Save(optFileName.LocalPath);
//            }
...
//                XmlDocument xDoc = new XmlDocument();
//                xDoc.PreserveWhitespace = false;
//                xDoc.Load(optFileName.LocalPath);
//                XmlNode xNode;
//                xNode = xDoc.SelectSingleNode("//designerstate");
