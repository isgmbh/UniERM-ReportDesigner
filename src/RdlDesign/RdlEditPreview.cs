...
namespace Reporting.RdlDesign
{
	...
	internal class RdlEditPreview : System.Windows.Forms.UserControl
	{
		...
		public RdlEditPreview()
		{
            ...
            //TODO Refactor RdlViewer so I can get to this function.
            //dcTopRuler.Offset = dcLeftRuler.Width + RdlViewer.RdlViewer.PixelsX(DesignXmlDraw.LEFTGAP, DpiX );
        ...
        internal Viewer.RdlViewer PreviewCtl
        {
