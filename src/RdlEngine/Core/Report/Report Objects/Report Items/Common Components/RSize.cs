...
namespace Reporting.Rdl
{
	...
	public class RSize
	{
        ...
        internal const decimal PARTS_PER_POINT = (decimal)(PARTS_PER_INCH / Measurement.POINTSIZE_M);
        internal const decimal PARTS_PER_PICA = (decimal)(PARTS_PER_POINT * 12M);

		int _Size;					// Normalized size in 1/100,000 meters (10 microns)
		...
		internal RSize(ReportDefn r, string t)
		{
			...
			if (_Size > 160 * PARTS_PER_INCH)	// Size can't be greater than 160 inches according to spec
...
//				_Size = 160 * 2540;     // this would force maximum to spec max of 160
        ...
        {
            return (float)((double)size / (double)PARTS_PER_INCH * Measurement.POINTSIZE_F);
        }
        ...
        //    get
        //    {	
        //        return (float) ((double) _Size / PARTS_PER_INCH * Measurement.POINTSIZE_F);
        //    }
        //}
        ...
        internal int Twips
        {
            get
            {
                return Measurement.TwipsFromPoints(this.ToPoints());
            }
        }
