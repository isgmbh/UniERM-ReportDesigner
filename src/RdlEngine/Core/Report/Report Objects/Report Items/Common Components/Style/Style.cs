	...
	internal class Style : ReportLink
	{
		...
		internal void DrawBackground(Report rpt, Graphics g, Row r, System.Drawing.Rectangle rect)
		{
				...
				this.BackgroundColor != null)
			{
				...
				Color c = Xml.ColorFromHtml(bgc, System.Drawing.Color.White, rpt.rl);

				string bgec = this.BackgroundGradientEndColor.EvaluateString(rpt, r);
				Color ec = Xml.ColorFromHtml(bgec, System.Drawing.Color.White, rpt.rl);
		...
		internal void DrawBorder(Report rpt, Graphics g, Row r, System.Drawing.Rectangle rect)
		{
			...
			if (BorderColor != null)
			{
				if (BorderColor.Default != null)
				{
					...
					topColor = bottomColor = leftColor = rightColor = 
						Xml.ColorFromHtml(v, System.Drawing.Color.Black, rpt.rl);
				}
				if (BorderColor.Top != null)
				{
					v = BorderColor.Top.EvaluateString(rpt, r);
					topColor = Xml.ColorFromHtml(v, System.Drawing.Color.Black, rpt.rl);
				}
				if (BorderColor.Bottom != null)
				{
					v = BorderColor.Bottom.EvaluateString(rpt, r);
                    bottomColor = Xml.ColorFromHtml(v, System.Drawing.Color.Black, rpt.rl);
				}
				if (BorderColor.Left != null)
				{
					v = BorderColor.Left.EvaluateString(rpt, r);
                    leftColor = Xml.ColorFromHtml(v, System.Drawing.Color.Black, rpt.rl);
				}
				if (BorderColor.Right != null)
				{
					v = BorderColor.Right.EvaluateString(rpt, r);
                    rightColor = Xml.ColorFromHtml(v, System.Drawing.Color.Black, rpt.rl);
				}
			}
			...
			if (BorderWidth != null)
			{
				...
				{
					topWidth = bottomWidth = leftWidth = rightWidth = (int) new RSize(this.OwnerReport, BorderWidth.Default.EvaluateString(rpt, r)).ToPixels();
				}
				if (BorderWidth.Top != null)
				{
                    topWidth = (int)new RSize(this.OwnerReport, BorderWidth.Top.EvaluateString(rpt, r)).ToPixels();
				}
				if (BorderWidth.Bottom != null)
				{
                    bottomWidth = (int)new RSize(this.OwnerReport, BorderWidth.Bottom.EvaluateString(rpt, r)).ToPixels();
				}
				if (BorderWidth.Left != null)
				{
                    leftWidth = (int)new RSize(this.OwnerReport, BorderWidth.Left.EvaluateString(rpt, r)).ToPixels();
				}
				if (BorderWidth.Right != null)
				{
                    rightWidth = (int)new RSize(this.OwnerReport, BorderWidth.Right.EvaluateString(rpt, r)).ToPixels();
				}
			}
		...
		internal void DrawStyleLine(Report rpt, Graphics g, Row r, Point s, Point e)
		{
			...
			try
			{
				...
				if (BorderWidth != null && BorderWidth.Default != null)
                    width = (int)new RSize(this.OwnerReport, BorderWidth.Default.EvaluateString(rpt, r)).ToPixels();
				else
					width = 1;
				...
				if (BorderColor != null && BorderColor.Default != null)
				{
                    ...
                    color = Xml.ColorFromHtml(v, System.Drawing.Color.Black, rpt.rl);
				}
				else
		...
		internal Brush GetBrush(Report rpt, Row r)
		{
			...
			if (this.Color != null)
			{
                ...
                Color color = Xml.ColorFromHtml(c, System.Drawing.Color.Black, rpt.rl);
		...
		internal Color EvalBackgroundColor(Report rpt, Row row)
		{
            ...
            return Xml.ColorFromHtml(c, System.Drawing.Color.Empty, rpt.rl);
		}
		...
		internal Color EvalColor(Report rpt, Row row)
		{
            ...
            return Xml.ColorFromHtml(c, System.Drawing.Color.Black, rpt.rl);
		}
