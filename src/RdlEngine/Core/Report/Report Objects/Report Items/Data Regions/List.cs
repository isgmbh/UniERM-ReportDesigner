			...
			foreach(XmlNode xNodeLoop in xNode.ChildNodes)
			{
				...
				switch (xNodeLoop.Name)
				{
					...
					case "DataInstanceElementOutput":
						_DataInstanceElementOutput = Reporting.Rdl.DataInstanceElementOutput.GetStyle(xNodeLoop.InnerText, OwnerReport.rl);
						break;
					default:	
...
//			p.YOffset += (Top == null? 0: this.Top.Points);
		...
		{		   
			...
			{
				float top = (float) (tb.Top == null? 0.0 : tb.Top.ToPoints());
		...
		class WorkClass
		{
			...
			{
				CalcHeight = l.Height == null? 0: l.Height.ToPoints();
				Data=null;
				Groups=null;
			}
		}
