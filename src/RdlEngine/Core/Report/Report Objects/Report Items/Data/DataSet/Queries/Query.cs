			...
			foreach(XmlNode xNodeLoop in xNode.ChildNodes)
			{
				...
				switch (xNodeLoop.Name)
				{
					case "DataSourceName":
						...
						break;
					case "CommandType":
						_QueryCommandType = Reporting.Rdl.QueryCommandType.GetStyle(xNodeLoop.InnerText, OwnerReport.rl);
						break;
					case "CommandText":
					...
					case "QueryParameters":
						...
						break;
					case "Timeout":
						_Timeout = Conversion.ToInteger(xNodeLoop.InnerText);
						break;
					case "RowLimit":				// Extension of RDL specification
						_RowLimit = Conversion.ToInteger(xNodeLoop.InnerText);
						break;
					default:	
