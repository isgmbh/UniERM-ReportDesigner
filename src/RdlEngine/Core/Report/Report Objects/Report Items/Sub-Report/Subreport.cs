...
namespace Reporting.Rdl
{
	...
	internal class Subreport : ReportItem
	{
        ...
        public float _yOffset;  //height of subreport, http://fyireporting.com/forum/viewtopic.php?t=774 
		...
		internal Subreport(ReportDefn r, ReportLink p, XmlNode xNode) :base(r, p, xNode)
		{
            ...
            _yOffset = 0; // http://fyireporting.com/forum/viewtopic.php?t=774
			...
			foreach(XmlNode xNodeLoop in xNode.ChildNodes)
			{
				...
				switch (xNodeLoop.Name)
				{
					...
					case "MergeTransactions":
						_MergeTransactions = Conversion.ToBoolean(xNodeLoop.InnerText, OwnerReport.rl);
						break;
					default:	
