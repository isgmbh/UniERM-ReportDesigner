...
namespace Reporting.Rdl
{
	...
	public partial class Report
	{
        ...
        //shfolder can be used to get the paths of different windows special folders
		...
		{
            // Get the location of the windows font directory
            //StringBuilder lpszPath = new StringBuilder(260);
            //SHGetFolderPath(IntPtr.Zero, (int)0x14, IntPtr.Zero, 0, lpszPath); //0x14 = Fonts
            FontFolder = Environment.GetFolderPath(Environment.SpecialFolder.Fonts); // lpszPath.ToString();
		...
		private void RunRenderXmlTransform(IStreamGen sg, MemoryStreamGen msg)
		{
			try
			{
				...
				Xml.XslTransform(file, msg.GetText(), sg.GetStream());
			}	
			catch (Exception ex)
			{
		...
		public Pages BuildPages()
		{
			...
			pgs.PageHeight = _Report.PageHeight.ToPoints();
            pgs.PageWidth = _Report.PageWidth.ToPoints();
			try
			{
		...
		{
            get { return _Report.PageHeight.ToPoints(); }
		}
		/// <summary>
        ...
        {
            get { return _Report.LeftMargin.ToPoints(); }
        }
        /// <summary>
        ...
        {
            get { return _Report.RightMargin.ToPoints(); }
        }
        /// <summary>
        ...
        {
            get { return _Report.TopMargin.ToPoints(); }
        }
        /// <summary>
        ...
        {
            get { return _Report.BottomMargin.ToPoints(); }
        }
        /// <summary>
	...
	// holder objects for value types (Used in the RCache for the Hashtable)
