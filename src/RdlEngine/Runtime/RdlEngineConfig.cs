        ...
        static public void RdlEngineConfigInit(params string[] dirs)
        {
            ...
            foreach (string dir in dirs)
            {
                ...
                {   // can't do much about failures; no place to report them 
                    ...
                    System.Diagnostics.Debug.WriteLine("Error opening RdlEngineConfig.xml: {0}", ex.Message);
                }
                if (bLoaded)
                    break;
            }
...
<config> 
   <DataSources> 
      ...
      <DataSource> 
         ...
         <ClassName>Reporting.Data.XmlConnection</ClassName> 
      ...
      <DataSource> 
         ...
         <CodeModule>DataProviders.dll</CodeModule> 
         <ClassName>Reporting.Data.WebServiceConnection</ClassName> 
         <TableSelect></TableSelect> 
      ...
      <DataSource> 
         ...
         <CodeModule>DataProviders.dll</CodeModule> 
         <ClassName>Reporting.Data.LogConnection</ClassName> 
         <TableSelect></TableSelect> 
         <Interface>File</Interface> 
      </DataSource> 
      <DataSource> 
         ...
         <CodeModule>DataProviders.dll</CodeModule> 
         <ClassName>Reporting.Data.TxtConnection</ClassName> 
         <TableSelect></TableSelect> 
         <Interface>File</Interface> 
      </DataSource> 
      <DataSource> 
         ...
         <CodeModule>DataProviders.dll</CodeModule> 
         <ClassName>Reporting.Data.FileDirConnection</ClassName> 
         <TableSelect></TableSelect> 
         <Interface>File</Interface> 
      </DataSource> 
   </DataSources> 
  ...
  <CustomReportItems> 
    <CustomReportItem>
      <Type>BarCode 128</Type>
      <CodeModule>RdlCri.dll</CodeModule>
      <ClassName>Reporting.Rdl.BarCode128</ClassName>
    </CustomReportItem>
    <CustomReportItem>
      <Type>BarCode EAN-13</Type>
      <CodeModule>RdlCri.dll</CodeModule>
      <ClassName>Reporting.Rdl.BarCodeEAN13</ClassName>
    </CustomReportItem>
    <CustomReportItem>
      <Type>BarCode Bookland</Type>
      <CodeModule>RdlCri.dll</CodeModule>
      <ClassName>Reporting.Rdl.BarCodeBookland</ClassName>
    </CustomReportItem>
  </CustomReportItems> 
</config>";
            }
        ...
        static void GetDataSource(IDictionary dsDir, XmlNode xNode)
        {
            ...
            {   // load the module early; saves problems with concurrency later 
                ...
                if (codemodule != null && cname != null)
                {
                    ...
                    if (la == null)
                        la = Utility.Assembly.AssemblyLoadFrom(codemodule);
                    if (la == null)
    ...
    internal class CompressionConfig
    {
        ...
        void Init()
        {
            lock (this)
            {
                ...
                {
                    // Load the assembly 
                    _Assembly = Utility.Assembly.AssemblyLoadFrom(_CodeModule);
